      ...
      {token && email ? (
                  ...
                  <div>
                    ...
                    <div className="mt-2 relative">
                      <input
                        ...
                        className="block w-full rounded-2xl border-0 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pr-12"
                      />
        ...
        <div className="min-h-screen flex flex-col justify-center items-center bg-gray-50/50">
          <div className="bg-white p-8 rounded-3xl shadow-xl text-center">
            <p className="text-red-500 font-bold text-lg">Incorrect or Expired Link</p>
            <p className="text-gray-500 mt-2">Please request a new password reset link.</p>
            <Link to="/forgot-password" class="mt-4 inline-block text-indigo-600 hover:text-indigo-500 font-semibold">
