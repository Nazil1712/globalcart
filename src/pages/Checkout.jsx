      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-12">
        <header className="mb-12">
          ...
          <p className="text-slate-500 font-medium">
            Complete your order and start experiencing premium quality.
          </p>
        </header>
                ...
                {addresses && addresses.length > 0 ? (
                    ...
                    {addresses.map((addr, index) => (
                      ...
                      >
                        <div className="flex justify-between items-start mb-4">
                          <div
                            className={`p-2 rounded-xl ${selectedAddress === addr ? "bg-indigo-600 text-white" : "bg-white text-slate-400 shadow-sm"}`}
                          >
                            <MapPinIcon className="w-5 h-5" />
                          </div>
                          <div
                            className={`h-5 w-5 rounded-full border-2 flex items-center justify-center transition-colors ${selectedAddress === addr ? "border-indigo-600" : "border-slate-200"}`}
                          >
                            {selectedAddress === addr && (
                  ...
                  <div className="text-center py-12 bg-slate-50 rounded-[2rem] border-2 border-dashed border-slate-200">
                    <p className="text-slate-400 font-bold">
                      No addresses found. Please add one above.
                    </p>
                  </div>
                )}
              </div>
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="mt-8 space-y-4">
                  ...
                  <Link
                    to="/"
                    className="block text-center text-sm font-bold text-slate-400 hover:text-indigo-600 transition-colors py-2"
                  >
                    Back to Shopping
                  </Link>
                </div>
